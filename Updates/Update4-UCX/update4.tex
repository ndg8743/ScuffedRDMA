...
UCX is the dominant open-source RDMA transport framework, used by NCCL, MPI, PyTorch, and Dask. While building libscuffedrdma, we identified recurring architectural issues in UCX's issue tracker and contributed six fixes upstream. This section summarizes the problems and our responses -- both the libscuffedrdma bypass and the direct UCX patches.
...
\addlinespace
\href{https://github.com/openucx/ucx/pull/11305}{\#11305} & \#1307 & Adaptive TX CQ moderation -- force signaled send when CQ credits run low, preventing TX stalls \\
\addlinespace
