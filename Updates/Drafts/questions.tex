...
\item GID index selection: I scan the GID table for the
IPv4-mapped entry because hard-coding index 0 was fragile on
consumer rxe devices. Is scanning still the right answer in
production, or is there a stable ioctl/sysfs path sites use?
...
exchange with retry. Security audit hardening lives here.
