...
\begin{axis}[
    ...
    ymax=500,
    xtick={1,2},
    xticklabels={Soft-RoCE, Hardware RoCEv2},
    xmin=0.2, xmax=2.8,
    nodes near coords,
...
\addplot[fill=red!30, draw=red!50] coordinates {(1, 189.61)};
\addlegendentry{Soft-RoCE}
\addplot[fill=green!40, draw=green!60] coordinates {(2, 0.71)};
\addlegendentry{Hardware RoCEv2}
\end{axis}
\end{tikzpicture}
...
\begin{axis}[
    ...
    xtick={1,2,3,4,5,6},
    xticklabels={Soft-RoCE, rdma-tas, Hardware RoCE, Tesla TTPoe, OCP Falcon, UEC 1.0},
    x tick label style={font=\small, rotate=20, anchor=north east},
    xmin=0.2, xmax=6.8,
    nodes near coords,
    nodes near coords align={vertical},
    every node near coord/.append style={font=\scriptsize},
...
% Deprecated
\addplot[fill=red!30, draw=red!50] coordinates {(1, 10)};
\addlegendentry{Deprecated}
% Research
\addplot[fill=pink!60, draw=pink!80] coordinates {(2, 5)};
\addlegendentry{Research}
% Production
\addplot[fill=green!40, draw=green!60] coordinates {(3, 2)};
\addlegendentry{Production}
\addplot[fill=green!40, draw=green!60, forget plot] coordinates {(4, 1.5)};
% Emerging
\addplot[fill=yellow!50, draw=yellow!70] coordinates {(5, 3.5)};
\addlegendentry{Emerging}
\addplot[fill=yellow!50, draw=yellow!70, forget plot] coordinates {(6, 1.8)};
\end{axis}
\end{tikzpicture}
