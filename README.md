...
| Path | What |
|------|------|
| [`middleware/`](middleware/README.md) | Transport abstractions (TCP/SoftRoCE/TTPoe) + libmesh-rdma bootstrap port |
| [`middleware/rdma_tensor_cache/`](middleware/rdma_tensor_cache/README.md) | libscuffedrdma core: dual QP pool, WFA, PMP, scuffedQuant |
| [`middleware/tests/`](middleware/tests/README.md) | pytest suite |
| [`benchmarks/`](benchmarks/README.md) | Dual QP, UCX, scuffedQuant benchmarks; results in `results/` |
| [`deployment/`](deployment/README.md) | Docker + K8s configs for cluster deployment |
| [`Updates/`](Updates/README.md) | Thesis updates (Update1-5 + Proposal + Drafts) |
| [`scripts/`](scripts/README.md) | Cluster setup scripts (SoftRoCE, TTPoe load, cluster bring-up) |
| [`RISVLLM-app/`](RISVLLM-app/README.md) | Sibling decompilation IDE (React + K8s). Separate from thesis. |
| `References/` | Bookmarked papers and articles used by the LaTeX updates |
| [`REFERENCES.md`](REFERENCES.md) | Curated annotated bibliography |
| `ucx/` | Submodule pointer to [openucx/ucx](https://github.com/openucx/ucx) for the upstream PR work |
