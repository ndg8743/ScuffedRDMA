"""
KV cache connector for disaggregated prefill/decode over RDMA.
...
via the centralized tensor database.
"""
...
class RDMAKVCacheConnector:
    ...
    to ship KV blocks to the centralized tensor database. On the decode
